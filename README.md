...
1. **Initial Setup**: When you run the program, the GUI window will display the initial Sudoku grid with pre-filled values.
2. **Solve the Puzzle**: Click the "Solve" button to solve the puzzle. The solution will be displayed if one is found.
3. **Clear the Grid**: Click the "Clear" button to clear the values of the solved cells, leaving the initial values intact.
